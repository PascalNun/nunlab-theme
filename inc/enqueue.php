...
function nunlab_enqueue_admin_assets( $hook_suffix ) {
	...
	wp_localize_script(
		...
		array(
			...
			'videoTypeLabel'       => __( 'Video slide', 'nunlab-theme' ),
			...
			'addVideoTitle'        => __( 'Select project videos', 'nunlab-theme' ),
			'addVideoButton'       => __( 'Use selected videos', 'nunlab-theme' ),
			'replaceVideoTitle'    => __( 'Select a video', 'nunlab-theme' ),
			'replaceVideoButton'   => __( 'Use this video', 'nunlab-theme' ),
			'chooseVideoLabel'     => __( 'Choose video', 'nunlab-theme' ),
			'replaceVideoLabel'    => __( 'Replace video', 'nunlab-theme' ),
			...
			'noPosterLabel'        => __( 'No poster selected', 'nunlab-theme' ),
